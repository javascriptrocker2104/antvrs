		...
		if (WTSQueryUserToken(wtsSession, &userToken))
		{
				...
				tsa.lpSecurityDescriptor != nullptr)
			{
					...
					&pi))
				{
					...
					std::wstring filePath = L"C:\\Users\\Анна\\Documents\\received_file.txt"; // Укажите путь куда сохранить файл
					...
					//Чтение полученного файла и запись в новый
					...
					std::string signatureFilePath = "C:\\Users\\Анна\\Downloads\\antvrs\\signatures.txt";
